  ...
  return (
    <article
      className={`
        ...
        prose-inline-code:bg-zinc-200 dark:prose-inline-code:bg-zinc-700 prose-inline-code:text-red-400 prose-inline-code:px-2 prose-inline-code:py-0.5 prose-inline-code:rounded-md
